...
uniform float iTime;
// uniform float iTimeDelta = 1.0;
// uniform float iFrame = 1.0;
// uniform float iChannelTime[4] = 1.0;
uniform vec4 iMouse;
// uniform vec4 iDate = vec4(1, 1, 1, 1);
// uniform float iSampleRate = 1.0;
// uniform vec3 iChannelResolution[4] = vec3(1, 1, 1);
