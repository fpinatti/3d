...
const main = () => {
	...
	// hdrBackground.mapping = THREE.EquirectangularReflectionMapping
	new RGBELoader()
		.load( 'textures/river_walk_1_4k.hdr', (texture) => {
...
window.addEventListener('DOMContentLoaded', async () => {
	...
	// await loadTexture('textures/river_walk_1_4k.hdr').then(texture => leafTexture = texture)
